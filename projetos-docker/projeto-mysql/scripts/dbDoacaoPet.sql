...
DROP TABLE IF EXISTS CATALOGO_VACINA;
...
CREATE TABLE CATALOGO_VACINA (
    id_catalogo_vacina INT AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE VACINA_PET (
    ...
    id_catalogo_vacina INT NOT NULL,
    id_pet INT NOT NULL,
    CONSTRAINT FK_PET_VACINA
        FOREIGN KEY (id_pet)
        REFERENCES PETS (id_pet)
        ON DELETE RESTRICT
        ON UPDATE CASCADE,
    CONSTRAINT FK_CATALOGO_VACINA_CATALAGO
        FOREIGN KEY (id_catalogo_vacina)
        REFERENCES CATALOGO_VACINA (id_catalogo_vacina)
        ON DELETE RESTRICT
        ON UPDATE CASCADE
) ENGINE=InnoDB CHARACTER SET utf8mb4;
...
INSERT INTO CATALOGO_VACINA (nome_vacina, id_catalogo_vacina) VALUES
('Polivalente', 1),
...
INSERT INTO PETS (nome, descricao, peso, data_nascimento, porte, sexo, id_tipo_especie, id_endereco_pet) VALUES
('Lerce', 'Cachorrinha dócil encontrado na rua', 12.50, '2020-01-01', 'Pequeno', 'Femea', 1, 1),
('Carlita', 'Gatinha arisca', 3.00, '2022-05-10', 'Pequeno', 'Femea', 2, 2),
('Thor', 'Cão de guarda bravo', 25.00, '2019-12-25', 'Grande', 'Macho', 1, 3),
('Rex', 'Vira-lata caramelo muito brincalhão', 15.00, '2021-03-15', 'Medio', 'Macho', 1, 4),
('Mia', 'Gata siamesa encontrada miando muito', 2.50, '2023-01-20', 'Pequeno', 'Femea', 2, 5),
('Bob', 'Cachorro idoso e calmo', 20.00, '2018-06-10', 'Medio', 'Macho', 1, 6),
('Luna', 'Gatinha preta muito carinhosa', 3.20, '2022-11-05', 'Pequeno', 'Femea', 2, 7),
('Max', 'Pastor Alemão filhote perdido', 10.00, '2023-08-01', 'Grande', 'Macho', 1, 8),
('Nina', 'Cadela SRD encontrada machucada', 8.00, '2022-02-14', 'Medio', 'Femea', 1, 9),
('Tobi', 'Gato rajado muito esperto', 4.00, '2021-09-30', 'Pequeno', 'Macho', 2, 10);

INSERT INTO VACINA_PET (id_vacina_pet, data_vacina, id_catalogo_vacina, id_pet) VALUES
(1, '2026-01-15', 1, 1),
(2, '2026-01-20', 2, 2),
(3, '2026-01-10', 3, 3),
(4, '2026-01-05', 1, 4),
